...
<tr>
   <td width="20%" align="center"><a href="book_down.jsp">图书管理</a></td>
...
<b align="center" ><form action="Select_from_table" method="post"><input type="hidden" value="book_down" name="input">
                                                                         索书号:<input type="text" id="search" name="search">
						  <input type="submit" value="检索"></form></b>
